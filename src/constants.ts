...
export const PENDING_NETWORK_SWITCH_CHAIN_KEY = 'orbs.pendingNetworkSwitchChainId';
...
export const hasInjectedProvider = (window as any).ethereum || (window as any).onto 
